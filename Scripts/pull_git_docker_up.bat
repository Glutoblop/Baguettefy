...
DEL /F /S /Q baguettefy 1>nul
RMDIR /S /Q baguettefy
...
git clone --branch main https://gitlab.com/nyetools/baguettefy.git baguettefy

:: Alongside this script is a dependency for my bot, a config file the bot needs to grab when it runs, copy that in. 
echo f | xcopy ".\config.json" ".\baguettefy\config.json"
